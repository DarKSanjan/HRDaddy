...
export const ORG_A_EMPLOYEES: SeedEmployee[] = [
  ...
  // Sales 2 — fills out the sales team
  {
    firstName: 'Hannah',
    lastName: 'Goh',
    email: 'hannah.goh@northstarstudios.sg',
    role: 'EMPLOYEE',
    department: 'Sales',
  ...
  // Finance 2 — gives Finance a team rather than a solo person
  {
    firstName: 'Ryan',
    lastName: 'Chua',
    email: 'ryan.chua@northstarstudios.sg',
    role: 'EMPLOYEE',
    department: 'Finance',
    ...
    residencyStatus: 'CITIZEN',
    compensationCents: 580000,
    managerId: 'lisa.koh@northstarstudios.sg',
  },
]
...
export const ORG_B_EMPLOYEES: SeedEmployee[] = [
  ...
  // Driver — adds depth to operations
  {
    firstName: 'Derek',
    lastName: 'Sim',
    email: 'derek.sim@harbourlogistics.sg',
    role: 'EMPLOYEE',
    department: 'Operations',
    ...
    residencyStatus: 'CITIZEN',
    compensationCents: 420000,
    managerId: 'cindy.yeo@harbourlogistics.sg',
  },
  // Accounts — gives management/admin another team member
  {
    firstName: 'Fiona',
    lastName: 'Tay',
    email: 'fiona.tay@harbourlogistics.sg',
    role: 'EMPLOYEE',
    department: 'Management',
    ...
    residencyStatus: 'CITIZEN',
    compensationCents: 450000,
    managerId: 'amy.chia@harbourlogistics.sg',
  },
]
